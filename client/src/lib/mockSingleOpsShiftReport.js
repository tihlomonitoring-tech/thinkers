...
export function buildMockSingleOpsShiftReport(rowsPerSection = 10, opts = {}) {
  ...
  return {
    ...
    shift_start: '06:00',
    shift_end: '18:00',
    controller1_name: 'Primary Telematics Specialist (Mock)',
    controller1_email: 'primary.telematics@example.com',
    controller2_name: 'Secondary Telematics Specialist (Mock)',
    controller2_email: 'secondary.telematics@example.com',
    status: 'Mock preview',
    ...
    declaration:
      'As the telematics specialist(s) on duty, I/we certify that the information in this shift report is accurate and complete to the best of my/our knowledge. (Mock preview document.)',
