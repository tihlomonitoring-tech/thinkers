...
import FleetDriverEnrollmentTab from './contractor/FleetDriverEnrollmentTab.jsx';
      ...
      <div className="flex-1 min-w-0 overflow-auto p-4 sm:p-6 flex flex-col">
        ...
        {loading ? (
          ...
          <>
            ...
            {activeTab === 'fleet-maintenance' && <FleetMaintenancePage />}
          ...
          {activeTab === 'manage-tab-access' && isSuperAdmin && (
            <ManagePageTabAccess
              pageKey="contractor"
              pageLabel="Contractor"
              allTabIds={CONTRACTOR_NAV.flatMap((g) => g.items.map((i) => i.id))}
              tabLabels={Object.fromEntries(CONTRACTOR_NAV.flatMap((g) => g.items.map((i) => [i.id, i.label])))}
              permissions={tabPermissions}
              setPermissions={setTabPermissions}
