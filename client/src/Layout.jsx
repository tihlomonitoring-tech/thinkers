...
export default function Layout() {
  ...
  const commandCentreTabTargets = canAccessPage(user, 'command_centre') ? [
    ...
    { id: 'cc:atomic_fleet', label: 'Command Centre · Atomic fleet verification', path: '/command-centre', section: 'Command Centre', commandCentreTab: 'atomic_fleet_verification', keywords: ['atomic', 'fleet', 'verification', 'telematics', 'haul'] },
