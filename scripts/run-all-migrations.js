...
const SCRIPTS = [
  ...
  'db:tasks-activity',
  'db:tasks-visibility-tenant-allocation',
  'db:case-management',
  'db:case-management-task-links',
  'db:company-library',
  ...
  'db:team-goals-schema',
  'db:performance-evaluations-schema',
  'db:user-page-roles-team-leader-admin',
  'db:user-page-roles-case-management',
  'db:user-page-roles-check-sync',
  'db:user-career-portfolio',
  'db:recruitment',
