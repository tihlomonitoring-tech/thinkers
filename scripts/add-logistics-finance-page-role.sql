-- Add logistics_finance_management to user_page_roles check constraint.
IF EXISTS (
...
ALTER TABLE dbo.user_page_roles ADD CONSTRAINT CK_user_page_roles_page_id CHECK (page_id IN (
  ...
  N'letters', N'accounting_management', N'tracking_integration', N'fuel_supply_management',
  N'fuel_customer_orders', N'fuel_data', N'team_leader_admin', N'performance_evaluations', N'auditor',
  N'company_library', N'quick_sign', N'report_generation', N'office_admin', N'logistics_finance_management'
));
GO
