...
import logisticsPlanningRoutes from './src/routes/logisticsPlanning.js';
...
app.get('/api/health', (req, res) => res.json({ ok: true, build: 'fuel-tabgrant-guid-fix-2026-06-30' }));
...
app.use('/api/logistics-planning', logisticsPlanningRoutes);
