/**
 * South Africa Basic Conditions of Employment Act (BCEA) — overtime reimbursement calc.
 * Simplified for claims: weekday OT 1.5×, Sunday 2×, public holiday 2× ordinary hourly wage.
 */
...
export const BCEA_OT = {
  ...
  /** Common monthly divisor (≈ 45h × 52 / 12) for ordinary hourly rate from salary */
...
/**
 * @returns {{ total: number, lines: Array<{ label: string, hours: number, rate: number, multiplier: number, subtotal: number }>, warnings: string[] }}
 */
