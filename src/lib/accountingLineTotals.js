/**
 * Line-item and document totals for quotations, invoices, POs.
 * VAT is calculated per line; document-level VAT % applies only when no line has VAT %.
 */
...
/** @param {object} l line with quantity, unit_price, discount_percent, tax_percent, description */
...
/**
 * @param {object[]} lines
 * @param {number} documentDiscountPercent
 * @param {number} documentTaxPercent — used only when no line has tax_percent > 0
 */
...
/** South African Rand display, e.g. R 1 234.56 */
...
/** Format numeric or pre-formatted amount strings with R prefix for statements. */
